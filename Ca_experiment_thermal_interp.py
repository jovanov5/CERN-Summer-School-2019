...
sim_name = 'Ca Experiment Thermal with Interpolation'
...
if __name__ == '__main__':
    with mp.Pool(mp.cpu_count()) as p:
        ...
        amp_thermal_span_int = np.linspace(-max_amp_thermal, max_amp_thermal, amp_thermal_span_int)  # to be interpolated
