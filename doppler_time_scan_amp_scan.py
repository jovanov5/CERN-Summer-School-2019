...
t_separation_max = 500  # PARAMETERS OF THE TIME SCAN (ns) separation
t_separation_min = 5
...
# TIME SCANNER FUNCTION for single t_sep (to be mapped on t_sep_span)
@numba.jit()
...
def signal_extraction(amp):
    ...
    return Exited_f(Gen_Rabi) / Exited_f(0)
